...
<head>
	...
	<title>Compose Messages - Scheduling and Reservation System for Tarlac San Sebastian Cathedral Parish</title>
...
<!-- end of Script to send message to admin -->
			<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
				...
				&nbsp;
				<input type="reset" value="Clear" class="btn btn-danger" onclick="document.findElementById('content').focus(); return false;"/>
