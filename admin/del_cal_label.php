...
<head>
	<title>Delete Calendar Label</title>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="center-div">
				<h2 class="white-text">Delete Calendar Label</h2>
				...
				<?php
					...
					$select = "SELECT * FROM cal_label ORDER BY content ASC";
					...
					if($select_query->num_rows > 0) {
						...
						while($row = $select_query->fetch_assoc()) {
							...
							echo "<td>";
							echo "<form action='delcallabel.php' method='post'>";
