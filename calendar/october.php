<?php
				...
				*/
				...
				$month_num = 10; //set the month here for example january is 1
			...
			<caption class="white-text"><strong><?php echo $month_name . " " . $year;?>&nbsp;<button class="btn btn-primary" onclick="november();">Next Month</button></strong></caption>
