...
<head>
	<title>Reservation Status - St. Augustine Parish Church Online Reservation and Scheduling</title>
...
<body>
	...
	<div class="container">
		...
		<h1 class="white-text text-center">St. Augustine Parish Church Online Scheduling and Reservation</h1>
<!-- Start of Navigation -->
<?php
/*
...
*/
	...
	$select_all_reserv = "SELECT * FROM reservation WHERE username = '$username' AND confirmation = 'Confirmed' AND reserv_date >= CURRENT_DATE() ORDER BY reserv_date, reserv_time ASC";
